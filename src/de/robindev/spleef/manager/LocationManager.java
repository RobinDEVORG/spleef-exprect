 ...
 * @author RobinDEV
 * 
 *         Der "LocationManager" verwaltet, wer hätte es gedacht, die Locations
 *         oder Positionen des Spiel, bspw. den Spawn
 */
public class LocationManager {
	 ...
	 * 
	 * @param location
	 *            Die Postion an der die Lobby gesetzt werden soll
	 ...
	 * 
	 * @param location
	 *            Die Postion an der die Map gesetzt werden soll
	 * @return Wenn die IOException auftritt, "false", andernfallls "true"
	 */
